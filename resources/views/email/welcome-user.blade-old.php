...
Dear {{ $first_name }},<br>
<br>
Your are now member for Ascent Partners.<br><br>
Your login details are as folows: <br>
Email: {{ $email }}<br>
Password: {{ $password }}<br><br>

Should you have any questions, please do not hesitate to contact Ascent Partners. <br><br>
