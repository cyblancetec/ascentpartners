   ...
   /* elems.forEach(function(html) {
    ...
    var sidebarAndContentHeight = function () {
        var content = $('.page-inner'),
            content = $('.page-inner.page-login'),
            sidebar = $('.page-sidebar'),
            body = $('body'),
            height,
            footerHeight = $('.page-footer').innerHeight(),
            pageContentHeight = $('.page-content').innerHeight();
        
        if($(".page-inner").hasClass("page-login")){
            content.attr('style', 'height:' + sidebar.innerHeight() + 'px ');
        } else{
            content.attr('style', 'min-height:' + sidebar.innerHeight() + 'px ');
        }
        
        
        if (body.hasClass('page-sidebar-fixed')) {
            height = sidebar.innerHeight() + footerHeight;
        } else {
            height = sidebar.innerHeight() + footerHeight;
        ...
        $('.page-sidebar-fixed .page-sidebar .slimScrollDiv').css('height',sidebar.innerHeight()+'px');
    };
    
    sidebarAndContentHeight();
    window.onload = sidebarAndContentHeight;
