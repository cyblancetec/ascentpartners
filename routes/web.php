...
function()
{
    ...
    Route::post('/stakeholder-welcome-continue', 'user\FrontendController@stakeholderWelcomeContinue');
...
Route::group(['prefix' => 'admin'], function(){
    ...
    Route::get('all-companies-survey-report', 'admin\SurveyEntryController@allCompaniesSurveyReport')->name('all-companies-survey-report');
    Route::post('all-companies-filter', 'admin\SurveyEntryController@allCompaniesFilter')->name('all-companies-filter');
    Route::get('individual-company-survey-report', 'admin\SurveyEntryController@individualCompanySurveyReport')->name('individual-company-survey-report');
    Route::post('individual-company-filter', 'admin\SurveyEntryController@individualCompanyFilter')->name('individual-company-filter');
